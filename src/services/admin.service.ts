...
export const adminService = {
  // ==================== Round Management ====================
  async createRound(startTime: string, endTime: string, notes?: string) {
  ...
  async getUserStats(filters?: { limit?: number }) {
    const { data, error } = await supabase.functions.invoke('admin-stats-users', {
